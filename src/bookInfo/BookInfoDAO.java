...
//		pstmt = con.prepareStatement(sql);
	...
	public boolean update2(String book_num, String mem_id) {
		String sql = "update book set mem_id= ?, l_date=?, r_date=?, inventory = 0 where book_num=?";
	      try {
	...
	public boolean update3(String mem_id) {
		String sql = "update book set mem_id=null, l_date=null, r_date=null, inventory = 1 where mem_id=?";
	      try {
	      pstmt = con.prepareStatement(sql);
	      pstmt.setString(1, mem_id);
	      pstmt.executeUpdate();
